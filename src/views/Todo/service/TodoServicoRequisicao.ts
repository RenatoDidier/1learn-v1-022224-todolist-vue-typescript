...
export async function EditarAtividadeRequest<T>(parametros: Atividade) :Promise<AxiosResponse<T>>
{
  return await RequestPutAsync<T>(ENDPOINT_EDITAR_ATIVIDADE, parametros);
}
